...
const Header = observer(() => {
  ...
  return (
    <div className="header_container flex flex-col items-center justify-evenly mt-5 gap-5">
                ...
                <NavLink to={"/profile"}>
                    <div>
                        <svg width="24" height="24" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="20" cy="20" r="19" stroke="currentColor" stroke-width="1.5" fill="white"/>
                            <circle cx="20" cy="14" r="5" stroke="currentColor" stroke-width="1.5" fill="white"/>
                            <path d="M8 32C8 28 12 24 20 24C28 24 32 28 32 32" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                        </svg>
                        <h2>Profile</h2>
                    </div>
                </NavLink>
